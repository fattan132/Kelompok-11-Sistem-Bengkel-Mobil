...
<div class="container">
    <div class="row mb-4">
        <div class="col-md-12">
            <h2 class="mb-1"><i class="fas fa-user-plus"></i> Tambah Customer Baru</h2>
            <p class="text-muted">Daftarkan customer baru</p>
        </div>
    </div>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-dark text-white">
                    <h5 class="mb-0"><i class="fas fa-user"></i> Form Customer</h5>
                </div>
                <div class="card-body">
                    @if ($errors->any())
