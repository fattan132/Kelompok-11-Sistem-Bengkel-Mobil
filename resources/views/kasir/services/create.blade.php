...
<div class="container">
    <div class="row mb-4">
        <div class="col-md-12">
            <h2 class="mb-3"><i class="fas fa-plus-circle"></i> Tambah Layanan Baru</h2>
            <p class="text-muted">Isi form untuk menambahkan layanan servis baru</p>
        </div>
    </div>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-dark text-white">
                    <h5 class="mb-0"><i class="fas fa-edit"></i> Form Layanan</h5>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('kasir.services.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('difficulty_level') is-invalid @enderror" 
                                        ...
                                        <option value="custom" {{ old('difficulty_level') == 'custom' ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" id="has_custom_fee" name="has_custom_fee" 
                                               value="1" {{ old('has_custom_fee') ? 'checked' : '' }}>
